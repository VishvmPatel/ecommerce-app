    ...
    const fetchData = async () => {
      try {
        ...
        const [productsResponse, filterOptionsResponse] = await Promise.all([
          apiService.getProductsByGender('women', 20),
        ...
        setError('Error loading women\'s products');
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-pink-100 to-purple-100 text-pink-800 text-sm font-medium mb-6">
            ✨ Women's Collection
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover elegant and stylish fashion pieces designed for the modern woman. From casual wear to formal attire, find your perfect style.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-2">Casual Wear</h3>
              <p className="text-pink-100 mb-4">Comfortable everyday fashion</p>
              <Link to="/women?category=Casual Wear" className="inline-flex items-center text-sm font-semibold hover:text-pink-200 transition-colors">
                Shop Now
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-2">Ethnic Wear</h3>
              <p className="text-purple-100 mb-4">Traditional elegance</p>
              <Link to="/women?category=Ethnic Wear" className="inline-flex items-center text-sm font-semibold hover:text-purple-200 transition-colors">
                Shop Now
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="relative z-10">
              ...
              <p className="text-indigo-100 mb-4">Professional sophistication</p>
              <Link to="/women?category=Formal Wear" className="inline-flex items-center text-sm font-semibold hover:text-indigo-200 transition-colors">
                Shop Now
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-teal-600 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-2">Activewear</h3>
              <p className="text-green-100 mb-4">Fitness and comfort</p>
              <Link to="/women?category=Activewear" className="inline-flex items-center text-sm font-semibold hover:text-green-200 transition-colors">
                Shop Now
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
