...
import { HeartIcon, HeartIcon as HeartSolidIcon, ShoppingBagIcon, FunnelIcon, XMarkIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
    ...
    const fetchData = async () => {
      try {
        ...
        const [productsResponse, filterOptionsResponse] = await Promise.all([
          apiService.searchProducts(query, 20),
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Error Loading Search Results</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Found {filteredAndSortedProducts ? filteredAndSortedProducts.length : 0} products matching your search
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    {filterOptions.sizes && filterOptions.sizes.map(size => (
