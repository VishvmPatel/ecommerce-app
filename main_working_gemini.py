...
# Configure Google Gemini AI with environment variable
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyBeMIdpsCI4uFQyouOxmwLtD7ZgrhxcPo0")
...
class GeminiCustomerSupportBot:
    ...
    def generate_response(self, user_query: str, conversation_history: List[dict], session_id: str, language: str = "en") -> dict:
        ...
        try:
            ...
            language_prompts = {
                "en": "You are a helpful and friendly Fashion Forward customer support assistant. Answer the user's question based on the FAQ data provided. For general greetings and personal questions, respond warmly and ask how you can help. If you cannot find a relevant answer for specific product/service questions, escalate to human support.",
...
Please provide a helpful response in {language}. For general greetings like "hi", "hello", "how are you", respond warmly and ask how you can help. If the query cannot be answered from the FAQ data and is not a general greeting, respond with "I need to escalate this to human support. Please hold while I connect you with a specialist."
...
"""
            ...
            if self.model:
                try:
                    ...
                    print(f"Gemini AI response generated successfully")
    ...
    def calculate_similarity(self, query, faq):
        ...
        score += (question_matches / len(query_words)) * 0.2
        
        # Check keyword similarity (lower priority)
        if "keywords" in faq:
...
if __name__ == "__main__":
    import uvicorn
    print("Starting Fashion Forward AI Bot with Google Gemini...")
